 ...
 * 
 */
@WebServiceClient(name = "RaspberryPiServerImplService", targetNamespace = "http://ws/", wsdlLocation = "http://192.168.1.22:9990/ws/raspberry?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://192.168.1.22:9990/ws/raspberry?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://192.168.1.22:9990/ws/raspberry?wsdl', retrying as a local file");
