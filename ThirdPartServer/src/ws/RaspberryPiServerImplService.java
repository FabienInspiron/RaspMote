 ...
 * 
 */
@WebServiceClient(name = "RaspberryPiServerImplService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost.org:9999/ws/raspberry?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost.org:9999/ws/raspberry?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost.org:9999/ws/raspberry?wsdl', retrying as a local file");
